...
public class ChuyenBayDAOImpl implements ChuyenBayDAO {
    ...
    public ArrayList<ChuyenBay> getListChuyenBay(String NoiDi,String NoiDen,String Ngay){
        ...
        String sql="SELECT * FROM qlvemaybay.chuyenbay WHERE `DiaDiem_Di`='"+NoiDi+"' AND `DiaDiem_Den`='"+NoiDen+"' AND `Ngay`='"+Ngay+"';";
        ArrayList<ChuyenBay> arr=new ArrayList();
        try{
    ...
    public boolean updateCB(String macbcu,String macb,String hang,String ngaydi,String giodi,String ngayden,String gioden,int diadiemdi,int diadiemden,int giave,int slhktd){
        Connection connect=DBConnect.getConnection();
        //Chưa làm xong
        String sql="UPDATE `qlvemaybay`.`chuyenbay` SET `MaCB`='"+macb+"', `Hang`='"+hang+"', `NgayDi`='"+ngaydi+"', `GioDi`='"+giodi+"', `NgayDen`='"+ngayden+"', `GioDen`='"+gioden+"', `DiaDiem_Di`='"+diadiemdi+"', `DiaDiem_Den`='"+diadiemden+"', `GiaVe`='"+giave+"', `SLHKTD`='"+slhktd+"' WHERE `MaCB`='"+macbcu+"';";
        try{
            PreparedStatement pr=connect.prepareStatement(sql);
    ...
    public ChuyenBay getChuyenBay(int mahk){
        Connection connect=DBConnect.getConnection();
        ChuyenBay cb = new ChuyenBay();
        String sql="SELECT chuyenbay.* FROM qlvemaybay.hanhkhach,chuyenbay,ve WHERE hanhkhach.MaHK='"+mahk+"' and hanhkhach.MaHK=ve.MaHK group by hanhkhach.mahk;";
        try{
            PreparedStatement pr=connect.prepareStatement(sql);
            ResultSet rs=pr.executeQuery();
