(function ($)
{
    ...
    $.fn.coinslider = $.fn.CoinSlider = function (options)
    {
        init = function (el)
        {
            ...
            //Show up the button and theirs function
            $.setFields(el);
        ...
        $.setFields = function (el)
        {
            ...
            //Show and hide the "Trước " and "Kế tiếp button"
            ...
            //Pause the pannel when the user hover mouse
        ...
        $.setNavigation = function (el) {
            ...
            $('#cs-navigation-' + el.id).hide();
            $('#cs-navigation-' + el.id).append("<a href='#' id='cs-prev-" + el.id + "' class='cs-prev'>Trước</a>");
            $('#cs-navigation-' + el.id).append("<a href='#' id='cs-next-" + el.id + "' class='cs-next'>Kế Tiếp</a>");
