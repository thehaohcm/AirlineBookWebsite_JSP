    ...
    <head>
        ...
        <script>
         function kiemtra(){
             ...
             if(ngaydi.value.trim()==""){
                 alert("Xin bạn vui lòng chọn Ngày khởi hành");
                 return;
             }
             frm.submit();
         }   
    ...
    <body>
        ...
        <div class="main">
            ...
            <div class="SearchForm">
                <h2>Flight Search</h2>
                <form class="InsideSearchForm" id="frm" action="AvailableForm.jsp">
                    <div class="wrapper">
                        Điểm xuất phát

                        <select id="diadiemdi" name="diadiemdi" >
                            <%for (DiaDiem dd : DD.getListDiaDiem()) {%>
                            <option value="<%=dd.getMaDD()%>" <%=(dd.getTenDD().equals("Tp. Hồ Chí Minh")) ? "selected" : ""%> > <%=dd.getTenDD()%> </option>
                            <%}%>
                        </select>
                    ...
                    <div class="wrapper">
                        ...
                        <input id="ngaykhoihanh" name="ngaykhoihanh" type="date" min="05-04-2016"  />
                    </div>
                    <input class="SearchButton" type="button" onclick="kiemtra()" value="Tìm kiếm" />
                    <br>
                    <div align="right"><b><font size="10" color="red"><%=error%></font></b></div>
